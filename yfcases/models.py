...
class Survey(models.Model):
  ...
  surveyObjectViewLink = models.URLField(u'標的物(現場勘查)',max_length=500,null=True,blank=True)
...
class FinalDecision(models.Model):
  ...
  finalDecisionDeterminationFirst = models.CharField(u'最終判定(一拍)',max_length=10,null=True,blank=True)
  finalDecisionDeterminationSecond = models.CharField(u'最終判定(二拍)',max_length=10,null=True,blank=True)
  ...
  finalDecisionRegionalHeadFourth = models.CharField(u'區域負責人(四拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadGiveUp = models.CharField(u'區域負責人(放棄)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadDateFirst = models.CharField(u'區域負責人簽核日期(一拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadDateSecond = models.CharField(u'區域負責人簽核日期(二拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadDateThird = models.CharField(u'區域負責人簽核日期(三拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadDateFourth = models.CharField(u'區域負責人簽核日期(四拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadDateGiveUp = models.CharField(u'區域負責人簽核日期(放棄)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadWorkAreaFirst = models.CharField(u'區域負責人轄區(一拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadWorkAreaSecond = models.CharField(u'區域負責人轄區(二拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadWorkAreaThird = models.CharField(u'區域負責人轄區(三拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadWorkAreaFourth = models.CharField(u'區域負責人轄區(四拍)',max_length=10,null=True,blank=True)
  finalDecisionRegionalHeadWorkAreaGiveUp = models.CharField(u'區域負責人轄區(放棄)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueAFirst = models.CharField(u'副署人員A(一拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueASecond = models.CharField(u'副署人員A(二拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueAThird = models.CharField(u'副署人員A(三拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueAFourth = models.CharField(u'副署人員A(四拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueAGiveUp = models.CharField(u'副署人員A(放棄)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateAFirst = models.CharField(u'副署日期A(一拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateASecond = models.CharField(u'副署日期A(二拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateAThird = models.CharField(u'副署日期A(三拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateAFourth = models.CharField(u'副署日期A(四拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateAGiveUp = models.CharField(u'副署日期A(放棄)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaAFirst = models.CharField(u'副署轄區A(一拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaASecond = models.CharField(u'副署轄區A(二拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaAThird = models.CharField(u'副署轄區A(三拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaAFourth = models.CharField(u'副署轄區A(四拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaAGiveUp = models.CharField(u'副署轄區A(放棄)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueBFirst = models.CharField(u'副署人員B(一拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueBSecond = models.CharField(u'副署人員B(二拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueBThird = models.CharField(u'副署人員B(三拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueBFourth = models.CharField(u'副署人員B(四拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueBGiveUp = models.CharField(u'副署人員B(放棄)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateBFirst = models.CharField(u'副署日期B(一拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateBSecond = models.CharField(u'副署日期B(二拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateBThird = models.CharField(u'副署日期B(三拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateBFourth = models.CharField(u'副署日期B(四拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueDateBGiveUp = models.CharField(u'副署日期B(放棄)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaBFirst = models.CharField(u'副署轄區B(一拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaBSecond = models.CharField(u'副署轄區B(二拍)',max_length=10,null=True,blank=True)
  finalDecisionSubSigntrueWorkAreaBThird = models.CharField(u'副署轄區B(三拍)',max_length=10,null=True,blank=True)
